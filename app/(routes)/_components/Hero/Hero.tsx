      ...
      <div className="px-4 mx-auto overflow-hidden md:px-12 py-32 max-w-7xl ">
        ...
        <div className="flex flex-col justify-center items-center mt-20">
          <div className="text-center">
            ...
            <h1 className="mt-4 text-5xl font-medium sm:font-medium tracking-tighter text-white lg:text-7xl text-balance">
            Elevating Your Digital Presence 
            </h1>
            <p className="w-1/2 mx-auto mt-4 text-2xl font-medium text-white text-balance">
