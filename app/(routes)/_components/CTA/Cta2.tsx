      ...
      {showSection && (
        <section className="fixed top-0 flex items-center justify-center z-10  bg-black/60 w-full h-screen">
          <form
            ...
            className="relative bg-white w-full sm:w-3/4 md:w-3/4 lg:w-[40%] m-4 p-5 sm:p-10"
          >
            <div
              onClick={handleClose}
              className="absolute right-5 w-10 h-10 flex items-center justify-center cursor-pointer bg-gray-100 hover:bg-black hover:text-white transition ml-auto text-black md:mb-5"
            >
              <X />
            </div>
            <div>
            ...
            <div className="grid md:grid-cols-2 mb-5 md:gap-6 mt-5">
              <div className="mb-5">
                ...
                <input
                  type="text"
                  id="firstName"
                  className={`bg-gray-50 border border-gray-300 text-gray-900 text-lg rounded-none focus:ring-black focus:border-black block w-full p-2.5 drk:bg-gray-700 drk:border-gray-600 drk:placeholder-gray-400 drk:text-white drk:focus:ring-black drk:focus:border-black ${
